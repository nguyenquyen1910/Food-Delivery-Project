...
public class Users {
    ...
    @Column(name = "create_code_at")
    private Timestamp createCodeAt;
    ...
    public Timestamp getCreateCodeAt() {
        return createCodeAt;
    }

    public void setCreateCodeAt(Timestamp createCodeAt) {
        this.createCodeAt = createCodeAt;
    }
