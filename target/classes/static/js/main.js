...
if (forgotPasswordLink) {
  forgotPasswordLink.addEventListener("click", () => {
    ...
    if (forgotPasswordForm) {
      ...
      forgotPasswordForm.querySelectorAll('.form-message').forEach(message => {
        message.textContent = '';
      });
    }
  });
...
const backToLoginFormBtn = document.querySelector(".btn-back");
if(backToLoginFormBtn) {
  backToLoginFormBtn.addEventListener("click", () => {
  ...
  if (check === true) {
    ...
    try {
      ...
      if (result.success) {
        ...
        } else if(result.description === "Wrong old password") {
          document.querySelector(".password-cur-info-error").innerHTML =
